            ...
            <div class="card card-body">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <a href="https://placeholder.com/"><img src="https://via.placeholder.com/350x150" class="img-thumbnail" alt=""></a>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">website : ${profile.company.name}</li>
                    </ul>
                    <h4>Todo List</h4>
